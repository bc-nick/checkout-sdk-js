...
> = (paymentIntegrationService) => {
    const useRegistryV1 = !paymentIntegrationService.getState().getStoreConfig()?.checkoutSettings
      // TODO:: this experiment needs clarification
      .features['INT-5659.braintree_use_new_googlepay_customer_strategy'];

    if (useRegistryV1) {
        throw new Error('googlepaybraintree requires using registryV1');
    }
